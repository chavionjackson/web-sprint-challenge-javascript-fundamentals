...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const lower = array.map((animal) => animal.animal_name.toLowerCase());
    return lower;  
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPop = array.filter((pop) => pop.population < 5);
    return lowPop;
  }
  ...
  */
  ...
  function USApop(array){
    const total = array.reduce((accumulator, pop) => {
...
const cuboidTwo = new CuboidMakerTwo({length: 3, width: 5, height: 3})
//🦄🦄🦄 Test your volume and surfaceArea methods by uncommenting the logs below: 🦄🦄🦄
...
const cube = new CubeMaker({length: 5, width: 2, height: 2})
